...
import { type ActionLog, useActionLogs } from "@/entities/action";
import { useMe } from "@/features/slack-auth";
import { ErrorFallback, Skeleton } from "@/shared/ui";
import { ActionBreakdown, GrowthTimeline } from "@/widgets/stats-panel";

export const Route = createFileRoute("/_authed/stats")({ component: StatsPage });
...
function StatsPage() {
  ...
  const { data, error, isLoading, mutate } = useActionLogs(me?.userId, me?.slackTeamId, startDate);
