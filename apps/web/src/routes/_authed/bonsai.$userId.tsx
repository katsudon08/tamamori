...
import { bonsaiSchema, useBonsai } from "@/entities/bonsai";
import { getNextStageThresholds, useGrowthRules } from "@/features/bonsai-growth";
...
export const Route = createFileRoute("/_authed/bonsai/$userId")({ component: BonsaiPage });
...
function BonsaiPage() {
  ...
  const { data: growthRules = [] } = useGrowthRules();
